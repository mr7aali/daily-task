                        ...
                        <Box class="max-w-md mx-auto">
                            ...
                            <form onSubmit={handleSubmit(handleModal)}>
                                <Box class="Boxide-y Boxide-gray-200">
                                    ...
                                    <Box class="pt-4 flex items-center space-x-4">
                                        {/* <a  onClick={() => setOpen(false)} class="flex justify-center items-center w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none">
